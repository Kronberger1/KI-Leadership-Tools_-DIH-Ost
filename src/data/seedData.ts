...
// -----------------------------------------------------------------------
// Seed profiles  (original 8 + 5 new employees for auth demo + peer comparison)
// -----------------------------------------------------------------------
export const SEED_PROFILES: EmployeeProfile[] = [
  ...
  // --- new: linked to demo auth accounts ---
  { id: 'emp-hr-01', vorname: 'Lisa',   nachname: 'Mayer',   abteilung: 'Administration',          rolle: 'HR',             bewertungszeitraum: 'H1 2026' },
  // --- new: IT team for max.lead team view ---
  { id: 'emp-72',    vorname: 'Markus', nachname: 'Weber',   abteilung: 'IT',                      rolle: 'Product Owner',  bewertungszeitraum: 'H1 2026' },
  // --- new: Marketing/Grafik peers for anna.mit peer comparison (need ≥3 peers) ---
  { id: 'emp-75',    vorname: 'Julia',  nachname: 'Berger',  abteilung: 'Marketing-Kommunikation', rolle: 'Grafik',         bewertungszeitraum: 'H1 2026' },
  { id: 'emp-80',    vorname: 'Felix',  nachname: 'Gruber',  abteilung: 'Marketing-Kommunikation', rolle: 'Grafik',         bewertungszeitraum: 'H1 2026' },
  { id: 'emp-83',    vorname: 'Sara',   nachname: 'Novak',   abteilung: 'Marketing-Kommunikation', rolle: 'Grafik',         bewertungszeitraum: 'H1 2026' },
];
...
// emp-hr-01: Lisa Mayer, HR Admin — good on Outlook/Teams/Word, lower on technical
const ratingsHr01: Record<number, Level> = {
  1: 3, 2: 3, 3: 3, 4: 3,
  5: 3, 6: 3, 7: 3, 8: 3,
  9: 3, 10: 3, 11: 3, 12: 3,
  13: 2, 14: 1, 15: 2, 16: 2,
...
// emp-72: Markus Weber, IT Product Owner — mid-high
const ratings72: Record<number, Level> = {
  1: 3, 2: 3, 3: 3, 4: 3,
  5: 4, 6: 4, 7: 3, 8: 3,
  9: 3, 10: 2, 11: 3, 12: 3,
  13: 2, 14: 2, 15: 2, 16: 3,
...
// emp-75: Julia Berger, Grafik — mid-low (peer for anna.mit)
const ratings75: Record<number, Level> = {
  1: 2, 2: 2, 3: 2, 4: 2,
  5: 2, 6: 2, 7: 2, 8: 1,
  9: 3, 10: 3, 11: 3, 12: 2,
  13: 1, 14: 1, 15: 1, 16: 1,
...
// emp-80: Felix Gruber, Grafik — slightly higher (peer for anna.mit)
const ratings80: Record<number, Level> = {
  1: 3, 2: 2, 3: 2, 4: 2,
  5: 2, 6: 2, 7: 2, 8: 2,
  9: 3, 10: 3, 11: 2, 12: 2,
  13: 1, 14: 1, 15: 2, 16: 1,
...
// emp-83: Sara Novak, Grafik — lower range (peer for anna.mit)
const ratings83: Record<number, Level> = {
  1: 2, 2: 1, 3: 2, 4: 2,
  5: 2, 6: 1, 7: 2, 8: 1,
  9: 2, 10: 2, 11: 2, 12: 2,
  13: 2, 14: 1, 15: 2, 16: 1,
...
export const SEED_ASSESSMENTS: AssessmentData[] = [
  ...
  { employeeId: 'emp-hr-01', ratings: buildRatings(ratingsHr01),  lastUpdated: '2026-05-20T08:00:00Z' },
  { employeeId: 'emp-72',    ratings: buildRatings(ratings72),    lastUpdated: '2026-05-18T11:00:00Z' },
  { employeeId: 'emp-75',    ratings: buildRatings(ratings75),    lastUpdated: '2026-05-17T10:00:00Z' },
  { employeeId: 'emp-80',    ratings: buildRatings(ratings80),    lastUpdated: '2026-05-16T14:00:00Z' },
  { employeeId: 'emp-83',    ratings: buildRatings(ratings83),    lastUpdated: '2026-05-15T09:00:00Z' },
];
